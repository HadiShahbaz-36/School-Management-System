...
// Fetch student name to show who we are deleting
$stmt = $conn->prepare("SELECT stu_name FROM students WHERE stu_enrollment_number = ?");
$stmt->execute([$id]);
...
<head>
    <meta charset="UTF-8">
    <title>Confirm Deletion | SMS</title>
...
<body>
    ...
    <div class="delete-card">
        ...
        <p>This action cannot be undone. All academic records and PDF results for this student will be lost.</p>
    ...
    <footer>
        &copy; 2025 HADI SHAHBAZ | SMS SECURITY LAYER
    </footer>
